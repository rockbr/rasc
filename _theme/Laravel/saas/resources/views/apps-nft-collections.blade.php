    ...
    <div class="col-xl-3 col-md-4 col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!" class="text-body">3d Style <span class="badge bg-success-subtle text-success">4781</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-xl-3 col-md-4 col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!" class="text-body">Collectibles <span class="badge bg-success-subtle text-success">3468</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-xl-3 col-md-4 col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-16"><a href="#!" class="text-body">Videos <span class="badge bg-success-subtle text-success">1674</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
