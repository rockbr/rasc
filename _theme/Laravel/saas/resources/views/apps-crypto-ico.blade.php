        ...
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <h6 class="text-muted mb-0">$15,00,000 / $13,75,954 <span class="badge bg-success-subtle text-success">89.97%</span>
                    </h6>
                </div>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <h6 class="text-muted mb-1">$39,00,000 / $31,57,654 <span class="badge bg-success-subtle text-success">84.57%</span>
                    </h6>
                </div>
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
