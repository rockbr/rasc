                    ...
                    <div class="row">
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use the <code>border</code>, <code>border-*</code> <code>text-*</code> class with the below-mentioned variation to create a badge with the outline.
                                    </p>
                                    <div class="live-preview">
