            ...
            <div class="card pricing-box">
                <div class="card-body bg-light m-2 p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <h2 class="month mb-0">$19 <small class="fs-13 text-muted">/Month</small>
                            </h2>
                            <h2 class="annual mb-0"><small class="fs-16"><del>$228</del></small> $171
            ...
            <div class="card pricing-box">
                <div class="card-body bg-light m-2 p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <h2 class="month mb-0">$29 <small class="fs-13 text-muted">/Month</small>
                            </h2>
                            <h2 class="annual mb-0"><small class="fs-16"><del>$348</del></small> $261
                                <small class="fs-13 text-muted">/Year</small>
                            </h2>
                        </div>
                    </div>
                    <p class="text-muted">Excellent for scalling teams to build culture. Special plan
                        for professional business.</p>
                    <ul class="list-unstyled vstack gap-3">
                        <li>
                            <div class="d-flex">
                                <div class="flex-shrink-0 text-success me-1">
            ...
            <div class="card pricing-box ribbon-box right">
                <div class="card-body bg-light m-2 p-4">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <h2 class="month mb-0">$39 <small class="fs-13 text-muted">/Month</small>
                            </h2>
                            <h2 class="annual mb-0"><small class="fs-16"><del>$468</del></small> $351
                                <small class="fs-13 text-muted">/Year</small>
                            </h2>
                        </div>
                    </div>
                    <p class="text-muted">This plan is for those who have a team alredy and running a
                        large business.</p>
                    <ul class="list-unstyled vstack gap-3">
                        <li>
                            <div class="d-flex">
            ...
            <div class="card pricing-box">
                <div class="card-body bg-light m-2 p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <h2 class="month mb-0">$49 <small class="fs-13 text-muted">/Month</small>
                            </h2>
                            <h2 class="annual mb-0"><small class="fs-16"><del>$588</del></small> $441
                                <small class="fs-13 text-muted">/Year</small>
                            </h2>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-soft-success w-100 waves-effect waves-light">Sign
                                        up free</a>
                                </div>
                            </div>
                        </div>
