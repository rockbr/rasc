            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="547">0</span>k</h2>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="124">0</span>k</h2>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="107">0</span>K</h2>
                        <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="15.95">0</span>%</h2>
                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0">
