                ...
                <div class="bg-warning-subtle">
                    <div class="card-body pb-0 px-4">
                        ...
                        <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-body fw-semibold" data-bs-toggle="tab" href="#project-documents"
                                    role="tab">
                                    Documents
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-body fw-semibold" data-bs-toggle="tab" href="#project-activities"
                                    role="tab">
                                    Activities
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-body fw-semibold" data-bs-toggle="tab" href="#project-team"
                                    role="tab">
                                    Team
                                </a>
                            </li>
                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <div class="badge bg-warning fs-11">Inprogress</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
