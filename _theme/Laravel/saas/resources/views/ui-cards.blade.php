            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('build/images/small/img-8.jpg') }}"
                            alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('build/images/small/img-10.jpg') }}"
                            alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                    ...
                    <div class="card border card-border-primary">
                        ...
                        <div class="card-body">
                            <p class="card-text">Whether article spirits new her covered hastily sitting her. Money witty
                                books nor son add build on the card Chicken age had evening believe but proceed pretend mrs.
                            </p>
                            <div class="text-end">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="flex-shrink-0 me-3 avatar-xl rounded"
                                    alt="..." />
                                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-0 bg-light position-relative">
                                <div class="col-md-5">
                                    <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" class="rounded-start img-fluid"
                                        alt="..." />
                                </div>
