                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            ...
                            <div class="py-3">
                                <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard
                                        Template</a></h5>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">A mix of
                                                            friends and strangers heading off to find an adventure</a></h5>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">How to get
                                                            creative in your work ?</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Ruby Griffin</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">How to become
                                                            a best sale marketer in a year!</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Elwood Arter</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">Manage white
                                                            space in responsive layouts ?</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Nancy Martino</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">Stack designer
                                                            Olivia Murphy offers freelancing advice</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Erica Kernan</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">A day in the
                                                            of a professional fashion designer</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Jason McQuaid</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">Design your
                                                            apps in your own way</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                                                class="ri-user-3-fill text-success align-middle me-1"></i>
                                                            Henry Baird</li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5 class="fs-15"><a href="javascript:void(0);">How apps is
