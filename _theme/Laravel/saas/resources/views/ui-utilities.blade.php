    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Use border utilities to add or remove an element’s borders. Choose from all
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use below-mentioned class to an element to display the value of components
                ...
                <div class="live-preview">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-muted">Change the display value of elements when printing with our print
            ...
            <div class="card-body">
                ...
                <div class="live-preview">
                    <div>
                        ...
                        <p><a href="#" class="text-success pe-auto">This link</a> can be clicked (this is default
                            behavior).</p>
                        <p class="pe-none mb-0"><a href="#" class="text-success" tabindex="-1">This link</a> can
                            not be clicked because the <code>pointer-events</code> property is inherited from its
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use below mentioned classes to arrange elements easily with the edge
...
<div class="row">
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use <code>w-25</code>,<code>w-50</code>,<code>w-75</code>,<code>w-100</code>
                    or <code>w-auto</code> class to set width <code>25%</code>, <code>50%</code>, <code>75%</code>,
...
<code>&lt;div class=&quot;w-auto p-3 bg-light&quot;&gt;Width auto&lt;/div&gt;</code></pre>
    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use <code>h-25</code>,<code>h-50</code>,<code>h-75</code>,<code>h-100</code>
                    or <code>h-auto</code> class to set height <code>25%</code>, <code>50%</code>, <code>75%</code>,
                    <code>100%</code>, or <code>auto</code> by default respectively.</p>
                <div class="live-preview">
