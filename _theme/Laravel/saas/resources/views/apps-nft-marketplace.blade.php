        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-body">Creative filtered portrait</a></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details" class="text-body">Trendy fashion portraits</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details" class="text-body">Smillevers Crypto</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="#!" class="text-body">Tonya Noble</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="#!" class="text-body">Kevin Dawson</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="#!" class="text-body">Herbert Stokes</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="#!" class="text-body">Thomas Taylor</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="#!" class="text-body">James Price</a></h5>
