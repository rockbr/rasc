                ...
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="heading-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="displayheading-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="blockquotes-showcode" class="form-label text-muted">Show
                                Code</label>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>blockquote-outline</code> class to set
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    ...
                                    <p class="text-body mb-2">Custom Blockquote Outline Primary Example
                                    </p>
                                    <footer class="blockquote-footer mt-0">Angie Burt <cite
                                            title="Source Title">Designer</cite></footer>
                                </blockquote>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    ...
                                    <p class="text-body mb-2">Custom Blockquote Outline Secondary
                                        Example</p>
                                    <footer class="blockquote-footer mt-0">Angie Burt <cite
                                            title="Source Title">Designer</cite></footer>
                                </blockquote>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    ...
                                    <p class="text-body mb-2">Custom Blockquote Outline Success Example
                                    </p>
                                    <footer class="blockquote-footer mt-0">Angie Burt <cite
                                            title="Source Title">Designer</cite></footer>
                                </blockquote>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    ...
                                    <p class="text-body mb-2">Custom Blockquote Outline Danger Example
                                    </p>
                                    <footer class="blockquote-footer mt-0">Angie Burt <cite
                                            title="Source Title">Designer</cite></footer>
                                </blockquote>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    ...
                                    <p class="text-body mb-2">Custom Blockquote Outline Warning Example
                                    </p>
                                    <footer class="blockquote-footer mt-0">Angie Burt <cite
                                            title="Source Title">Designer</cite></footer>
                                </blockquote>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="unstyledlist-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="desclist-alignment-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="textwrap-showcode" class="form-label text-muted">Show
                                Code</label>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="mt-4">
                            <p class="text-muted">Use <code>text-nowrap</code> class to prevent text
                                from wrapping.</p>
...
&lt;/div&gt;</code></pre>
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="wordbreak-showcode" class="form-label text-muted">Show
                                Code</label>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div>
                            <p class="text-muted">Use <code>text-break</code> class to prevent long
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="fontsize-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="fontweight-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="lineheight-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="texttransform-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="textdecoration-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="texttruncation-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="visibility-showcode" class="form-label text-muted">Show
                                Code</label>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            <label for="clearfix-showcode" class="form-label text-muted">Show
                                Code</label>
                    ...
                    <div class="live-preview">
                        <div class="bg-light clearfix p-3">
                            <button type="button" class="btn btn-secondary float-start">Example Button
                                floated left</button>
                            <button type="button" class="btn btn-success float-end">Example Button
